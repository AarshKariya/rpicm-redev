  ...
  return (
    <div className={styles.courseEnquiryForm}>
      ...
      {/* <div className={styles.twoColumnContainer}>
        ...
        <div className={styles.column}>
          <div className={styles.horizontalOptions}>
            <input type="checkbox" id="partTime" value="part-time" />
            <label htmlFor="partTime">Part-time course</label>
            <input type="checkbox" id="fullTime" value="full-time" />
            <label htmlFor="fullTime">Full-time course</label>
          </div>
          <div className={styles.horizontalOptions}>
            ...
            />
            <label htmlFor="culturalHeritage">Cultural Heritage of India</label>
          </div>
          <input
            type="text"
            id="candidateName"
          ...
          <div className={styles.horizontalOptions}>
            <input type="radio" id="gen" name="category" value="gen" />
            <label htmlFor="gen">GEN</label>
            <input type="radio" id="sebc" name="category" value="sebc" />
            <label htmlFor="sebc">SEBC/OBC</label>
            <input type="radio" id="sc" name="category" value="sc" />
            <label htmlFor="sc">SC</label>
            <input type="radio" id="st" name="category" value="st" />
            <label htmlFor="st">ST</label>
            <input type="radio" id="ph" name="category" value="ph" />
          ...
          />
          <div className={styles.horizontalOptions}>
            <input type="radio" id="working" name="working" value="working" />
