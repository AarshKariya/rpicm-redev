      ...
      <div className={styles.history}>
        ...
        <div className={styles.historyContent}>
          <p className={styles.historyText}>
            ...
            Pioneer in Professional Education and Upskilling. Established in
            1961 as Bhavan’s College of Journalism, Advertising, and Printing,
            ...
            to include management education, leading to its present name.
          </p>
      ...
      <div className={styles.today}>
        <div className={styles.todayContent}>
          <div className={styles.todayImages}>
            <div className={styles.todayImage}>
              <Image
