    ...
    courseItems: [
      ...
      },
      {
        ...
        academicSchedule: [
          ...
          "Evaluation: Case Analysis (20%); Self-reflection manual with implementation details (50%), Quizzes & exercises (30%)",
          "90% attendance",
      ...
      },
      {
        ...
        academicSchedule: [
          "It will be 12 hours in duration.",
    ...
    courseItems: [
      {
        ...
        description:
          "Dr. K.M. Munshi, founder of Bharatiya Vidya Bhavan, envisaged that the content of culture is essential to creating good managers who could effectively steer the industries in the future. So, apart from the courses in Management and Communication, RPICM provides special guidance on the subject “Cultural Heritage of India”.",
        briefBullet: [
